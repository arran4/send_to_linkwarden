...
final IndividualKeyedPubSubReplay<String?, List<Tag>?> tagsReplayer =
    IndividualKeyedPubSubReplay<String?, List<Tag>?>(
      onNoLastMessage: (queue, currentKey) async {
        if (currentKey == null) {
        ...
        queue.publish(
          await getTags(ui.apiToken ?? "", ui.server ?? ""),
